...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='eventproxy',
            trigger=pgtrigger.compiler.Trigger(name='event_before_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "occasions_eventhistory" ("start", "end", "title", "description", "creator_id", "created_on", "updated_on", "rule_id", "end_recurring_period", "calendar_id", "color_event", "id", "pgh_created_at", "pgh_label", "pgh_obj_id", "pgh_context_id") VALUES (OLD."start", OLD."end", OLD."title", OLD."description", OLD."creator_id", OLD."created_on", OLD."updated_on", OLD."rule_id", OLD."end_recurring_period", OLD."calendar_id", OLD."color_event", OLD."id", NOW(), \'event.before_delete\', OLD."id", _pgh_attach_context()); RETURN NULL;', hash='480beb6f3958b764f15a42b94795714d4bf3b827', operation='DELETE', pgid='pgtrigger_event_before_delete_5b74a', table='schedule_event', when='AFTER')),
        ),
