    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pgh_obj', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='event', to='schedule.event')),
        ...
        migrations.RunSQL(Utility.pgh_default_sql('occasions_eventevent', index_on_id=True)),
    ]
