...
urlpatterns = [
    ...
    path(
        "attendingmeet_print_configuration/",
        view=attendingmeet_print_configuration_view,
        name="attendingmeet_print_configuration_view",
    ),
    path(
        "directory_report/",
    ...
    path(
        "attendingmeet_report/",
        view=attendingmeet_report_list_view,
        name="attendingmeet_report_list_view",
    ),
    path(
        "attendingmeet_envelopes/",
        view=attendingmeet_envelopes_list_view,
        name="attendingmeet_envelopes_list_view",
    ),
    path(
