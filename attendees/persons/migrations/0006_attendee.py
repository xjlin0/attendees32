...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='attendee',
            trigger=pgtrigger.compiler.Trigger(name='attendee_before_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "persons_attendeeshistory" ("created", "modified", "is_removed", "id", "division_id", "gender", "user_id", "infos", "first_name", "last_name", "first_name2", "last_name2", "photo", "actual_birthday", "estimated_birthday", "deathday", "pgh_created_at", "pgh_label", "pgh_obj_id", "pgh_context_id") VALUES (OLD."created", OLD."modified", OLD."is_removed", OLD."id", OLD."division_id", OLD."gender", OLD."user_id", OLD."infos", OLD."first_name", OLD."last_name", OLD."first_name2", OLD."last_name2", OLD."photo", OLD."actual_birthday", OLD."estimated_birthday", OLD."deathday", NOW(), \'attendee.before_delete\', OLD."id", _pgh_attach_context()); RETURN NULL;', hash='e1240b2485c36a9e7af4cf6f74deda9704fcba90', operation='DELETE', pgid='pgtrigger_attendee_before_delete_c7737', table='persons_attendees', when='AFTER')),
        ),
    ]
