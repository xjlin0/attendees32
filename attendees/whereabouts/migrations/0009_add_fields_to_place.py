...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='place',
            name='infos',
            field=models.JSONField(blank=True, default=attendees.persons.models.utility.Utility.default_infos, help_text="please keep {} here even there's no data", null=True),
        ),
